...
def train(
    ...
    output_dir: str = "../llama2_with_id_withExtraVal", # "../llama_without_id",
    ...
    # # wandb params
    use_wandb=True,
    wandb_project: str = "llama2Finetune_with_id",
    wandb_run_name: str = "2epochs",
    ...
    if int(os.environ.get("LOCAL_RANK", 0)) == 0:
        print(
            f"Training llama with identity model with params:\n"
    ...
    th=open('../data_with_id/train_data.jsonl','r')  # '../data_without_id/train_data_small_generic.jsonl'
    vh=open('../data_with_id/val_data.jsonl','r')    # '../data_without_id/val_data.jsonl'
