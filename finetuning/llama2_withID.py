...
def train(
    ...
    output_dir: str = "../models/llama2_with_id_withExtraVal", # "../llama_without_id",
    ...
    th=open('../datasets/finetune/bsr_withID/train_data.jsonl','r')  
    vh=open('../datasets/finetune/bsr_withID/val_data.jsonl','r')    
